<template>
  ...
  <div style="margin: 20px 0"><el-button>添加讲师</el-button></div>
        ...
        <el-dropdown>
          ...
          <template #dropdown>
            <el-dropdown-menu>
              ...
              <el-dropdown-item @click="handleStatus">
...
<script setup>
  ...
  const { query, page, handleQuery, resetQuery, handleDelete, handleStatus } = useTable({
