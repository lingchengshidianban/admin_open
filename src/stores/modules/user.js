...
function buildBreadcrumbMap(menuList) {
  ...
  recursiveMap(menuList, [], breadcrumbMap)
  return breadcrumbMap
}
function recursiveMap(menuList, parentList, breadcrumbMap) {
  for (const e of menuList) {
    ...
    breadcrumbMap.set(menuIdStr, cloneParentList)
    if (!isEmpty(e.children)) {
      recursiveMap(e.children, cloneParentList, breadcrumbMap)
    }
  }
}
